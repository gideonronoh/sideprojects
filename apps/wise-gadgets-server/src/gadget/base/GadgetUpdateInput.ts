...
class GadgetUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => InventoryUpdateManyWithoutGadgetsInput,
  })
  @ValidateNested()
  @Type(() => InventoryUpdateManyWithoutGadgetsInput)
  @IsOptional()
  @Field(() => InventoryUpdateManyWithoutGadgetsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => OrderUpdateManyWithoutGadgetsInput,
  })
  @ValidateNested()
  @Type(() => OrderUpdateManyWithoutGadgetsInput)
  @IsOptional()
  @Field(() => OrderUpdateManyWithoutGadgetsInput, {
    nullable: true,
  })
...
export { GadgetUpdateInput as GadgetUpdateInput };
