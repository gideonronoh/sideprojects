...
export class InventoryResolverBase {
  ...
  async createInventory(
    ...
    return await this.service.createInventory({
      ...
      data: {
        ...
        gadget: args.data.gadget
          ? {
              connect: args.data.gadget,
            }
          : undefined,
      },
    });
  ...
  async getGadget(@graphql.Parent() parent: Inventory): Promise<Gadget | null> {
    const result = await this.service.getGadget(parent.id);
