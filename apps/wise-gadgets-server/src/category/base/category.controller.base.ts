...
import { GadgetFindManyArgs } from "../../gadget/base/GadgetFindManyArgs";
...
export class CategoryControllerBase {
  ...
  async findGadgets(
    ...
    const query = plainToClass(GadgetFindManyArgs, request.query);
    const results = await this.service.findGadgets(params.id, {
      ...query,
      select: {
        category: {
          select: {
  ...
  @common.Post("/:id/gadgets")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async connectGadgets(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: GadgetWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      gadgets: {
        connect: body,
  ...
  @common.Delete("/:id/gadgets")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async disconnectGadgets(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: GadgetWhereUniqueInput[]
  ): Promise<void> {
    const data = {
